...
def prepocess_3sec(file, plot=True):
    raw = mne.io.read_raw_bdf('Data\\' + file, preload=True)
    ...
    epochs_a.plot(n_epochs = 9, n_channels = 10)
    ...
    epochs_a_resampled.plot(n_epochs = 9, n_channels = 10) 
    epochs_b_resampled.plot(n_epochs = 9, n_channels = 10) 
